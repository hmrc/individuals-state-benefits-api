...
class AmendBenefitValidatorFactorySpec extends UnitSpec with JsonErrorValidators {
  ...
  private val parsedBody      = AmendBenefitRequestBody("2020-04-06", Some("2021-01-01"))
  ...
  "validator" should {
    "return the parsed domain object" when {
      "passed a valid request" in {
        ...
        result shouldBe Right(AmendBenefitRequestData(parsedNino, parsedTaxYear, parsedBenefitId, parsedBody))
      }
    }
