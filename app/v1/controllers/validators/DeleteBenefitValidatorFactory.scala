...
class DeleteBenefitValidatorFactory {
  ...
  def validator(nino: String, taxYear: String, benefitId: String): Validator[DeleteBenefitRequestData] = new Validator[DeleteBenefitRequestData] {

    def validate: Validated[Seq[MtdError], DeleteBenefitRequestData] = {
      (
        ResolveNino(nino),
