...
import v1r6.connectors.DownstreamUri.{IfsUri, Release7Uri}
...
import v1r6.models.request.deleteBenefit.DeleteBenefitRawData
...
class DeleteBenefitController @Inject()(val authService: EnrolmentsAuthService,
  ...
  def deleteBenefit(nino: String, taxYear: String, benefitId: String): Action[AnyContent] =
    authorisedAction(nino).async { implicit request =>
      ...
      implicit val desUri: Release7Uri[Unit] = Release7Uri[Unit](
